...
import type { AlertSeverity, Sentiment, Platform } from '@/types';
...
export function AlertFilters({
    ...
    const dateRangeOptions: Array<{ value: '24h' | '7d' | '30d' | 'custom'; label: string }> = [
    ...
    const hasActiveFilters = severity !== 'all' || source !== 'all' || sentiment !== 'all' || dateRange !== '30d' || searchQuery !== '';
        ...
        <GlassCard className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select
                        value={dateRange}
                        onChange={(e) => onDateRangeChange(e.target.value as '24h' | '7d' | '30d' | 'custom')}
                        className="w-full px-3 py-2 bg-charcoal-800 border border-white/10 rounded-lg text-sm text-white focus:outline-none focus:border-electric-500/50 focus:ring-2 focus:ring-electric-500/20"
                    >
